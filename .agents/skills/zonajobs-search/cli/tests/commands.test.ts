...
function jobCard(overrides: Partial<JobCard> = {}): JobCard {
  return {
    ...
    date: "05-08-2026",
    url: "https://www.zonajobs.com.ar/empleos/desarrollador-jr-hipodromo-palermo-1118391216.html",
    ...overrides,
  };
}
...
describe("runDetail (mocked fetch)", () => {
  ...
  test("accepts a full URL as the id", async () => {
    ...
    const code = await runDetail(
      { id: "https://www.zonajobs.com.ar/empleos/x-1118391216.html", format: "json" },
    );
    expect(code).toBe(0);
