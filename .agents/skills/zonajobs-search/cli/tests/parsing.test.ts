...
describe("parseSearchResponse", () => {
  test("maps content to the contract envelope with id/title/company/location/date/url", () => {
    ...
    expect(r.url).toBe(
      "https://www.zonajobs.com.ar/empleos/desarrollador-a-de-software-jr-hipodromo-palermo-1118391216.html",
    );
  });
  ...
  test("confidential postings carry a null company", () => {
    ...
    expect(results[0].url).toBe(
      "https://www.zonajobs.com.ar/empleos/desarrollador-a-de-software-jr-1118391216.html",
    );
  });
...
describe("makeAvisoUrl", () => {
  test("includes company slug when not confidential", () => {
    expect(makeAvisoUrl("1118391216", "Desarrollador Jr", "Hipódromo Palermo", false)).toBe(
      "https://www.zonajobs.com.ar/empleos/desarrollador-jr-hipodromo-palermo-1118391216.html",
    );
  });

  test("omits company slug when confidential", () => {
    expect(makeAvisoUrl("1118391216", "Desarrollador Jr", null, true)).toBe(
      "https://www.zonajobs.com.ar/empleos/desarrollador-jr-1118391216.html",
    );
  });
});
...
describe("normalizeId", () => {
  test("extracts id from a /empleos/ URL", () => {
    expect(
      normalizeId("https://www.zonajobs.com.ar/empleos/desarrollador-jr-hipodromo-palermo-1118391216.html"),
    ).toBe("1118391216");
  });
